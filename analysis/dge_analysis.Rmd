...
```{r plotMA, fig.height=6, fig.cap = "*MA plot with blue curve through the data showing the GAM fit. The curve indicated a potential bias remains in the data. DE genes are highlighted in red.*"}
topTable %>%
...
These above results were exported as the file `r glue("{nm}.tsv")`.
